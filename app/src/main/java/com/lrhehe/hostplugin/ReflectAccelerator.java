...
// this is a copy from https://github.com/wequick/Small, thanks Small.
...
public class ReflectAccelerator {
    ...
    public static int addAssetPath(AssetManager assets, String path) {
        Method sAddAssetPath = getMethod(AssetManager.class,
    ...
    public static boolean expandDexPathList(ClassLoader cl, String dexPath,
        ...
        if (Build.VERSION.SDK_INT < 14) {
            try {
                ...
                expandArray(cl, sDexClassLoader_mFiles_field, new Object[] {
                        pathFile
                }, true);

                expandArray(cl, sDexClassLoader_mPaths_field, new Object[] {
                        dexPath
                }, true);

                ZipFile zipFile = new ZipFile(dexPath);
                expandArray(cl, sDexClassLoader_mZips_field, new Object[] {
                        zipFile
                }, true);

                DexFile dexFile = DexFile.loadDex(dexPath, optDexPath, 0);
                expandArray(cl, sDexClassLoader_mDexs_field, new Object[] {
                        dexFile
                }, true);
            } catch (Exception e) {
                return false;
     ...
     * 
     * @see <a
     *      href="https://github.com/casidiablo/multidex/blob/publishing/library/src/android/support/multidex/MultiDex.java">MultiDex</a>
     * @param target
     * @param arrField
     * @param extraElements
    ...
    private static void fillDexPathList(ClassLoader cl, Object element)
        ...
        expandArray(pathList, sDexElementsField, new Object[] {
                element
        }, true);
    }
    ...
    public static void setTheme(Activity activity, Resources.Theme theme) {
        Field sContextThemeWrapper_mTheme_field = getDeclaredField(
    ...
    public static void setResources(Activity activity, Resources resources) {
        ...
        Field sContextThemeWrapper_mResources_field = getDeclaredField(targetClass, "mResources");
    ...
    public static void setResources(Context context, Resources resources) {
        ...
        Field sContextImpl_mResources_field = getDeclaredField(
    ...
    /**
     * @see <a
     *      href="https://github.com/android/platform_frameworks_base/blob/gingerbread-release/core%2Fjava%2Fandroid%2Fcontent%2Fpm%2FPackageParser.java">PackageParser.java</a>
     */
    public static Signature[] getSignaturesV13(File plugin) {
        try {
            if (sPackageParser_constructor == null) {
                ...
                if (sPackageParser_parsePackage_method == null)
                    return null;
                ...
                sPackageParser_collectCertificates_method = getDeclaredMethod(clazz,
                        "collectCertificates",
                        new Class[] {
                                pkgClazz, Integer.TYPE
                        });
                if (sPackageParser_collectCertificates_method == null)
                    return null;

                sPackageParser$Package_mSignatures_field = getDeclaredField(pkgClazz, "mSignatures");
                if (sPackageParser$Package_mSignatures_field == null)
                    return null;
            }
